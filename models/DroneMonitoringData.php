...
class DroneMonitoringData {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " SET plantation_id=:plantation_id, dronefly_date=:dronefly_date, stage_id=:stage_id, no_of_pits=:no_of_pits, area_identified=:area_identified, no_of_seedling=:no_of_seedling, survival_rate=:survival_rate, year=:year, created_by=:created_by";

        $stmt = $this->conn->prepare($query);

        $stmt->bindParam(":plantation_id", $this->plantation_id);
        $stmt->bindParam(":dronefly_date", $this->dronefly_date);
