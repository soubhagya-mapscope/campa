                        ...
                        <div class="col-md-12">
                            ...
                            <fieldset class="pre-plantation-fieldset w-100">
                                ...
                                ?>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-6 row-label">Pit Target Deviation:</div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-6 row-label">Plantation Area as per Ortho (Ha):</div>
                                        ...
                                        foreach ($droneData['postPlantationData'] as $data) : ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card mt-2 mb-4 px-4 py-4">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-6 row-label">No of Plants Identified (Nos):</div>
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-6 row-label">Plantation Target Deviation   (Nos):</div>
